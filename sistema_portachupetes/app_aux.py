...
from crud.pedidos import crear_pedido, cancelar_pedido, modificar_pedido, terminar_pedido, listar_todos_pedidos,obtener_pedido, listar_materiales_pedido
import pandas as pd
...
if authentication_status:
    ...
    if eleccion == 'Home':
        ...
        st.markdown(st.secrets['DATABASE_URL'])
        st.divider()
